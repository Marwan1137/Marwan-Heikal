...
// in meal_tracker/test/UI/cubit/cubit_meal_test.dart.
...
import 'package:meal_tracker/domain/usecases/add_meal_usecase.dart' as _i6;
import 'package:meal_tracker/domain/usecases/delete_meal_usecase.dart' as _i7;
import 'package:meal_tracker/domain/usecases/sort_meal_usecase.dart' as _i8;
import 'package:meal_tracker/domain/usecases/update_meal_usecase.dart' as _i9;
...
/// A class which mocks [AddMealUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockAddMealUsecase extends _i1.Mock implements _i6.AddMealUsecase {
  MockAddMealUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Result<_i5.Meal>> call(_i5.Meal? meal) =>
      (super.noSuchMethod(
            Invocation.method(#call, [meal]),
            returnValue: _i4.Future<_i2.Result<_i5.Meal>>.value(
              _FakeResult_0<_i5.Meal>(this, Invocation.method(#call, [meal])),
            ),
          )
          as _i4.Future<_i2.Result<_i5.Meal>>);
}

/// A class which mocks [DeleteMealUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockDeleteMealUsecase extends _i1.Mock implements _i7.DeleteMealUsecase {
  MockDeleteMealUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Result<bool>> call(String? id) =>
      (super.noSuchMethod(
            Invocation.method(#call, [id]),
            returnValue: _i4.Future<_i2.Result<bool>>.value(
              _FakeResult_0<bool>(this, Invocation.method(#call, [id])),
            ),
          )
          as _i4.Future<_i2.Result<bool>>);
}

/// A class which mocks [SortMealUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockSortMealUsecase extends _i1.Mock implements _i8.SortMealUsecase {
  MockSortMealUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<_i2.Result<List<_i5.Meal>>> call({
    required List<_i5.Meal>? meals,
    required _i3.SortBy? sortBy,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#call, [], {#meals: meals, #sortBy: sortBy}),
            returnValue: _i4.Future<_i2.Result<List<_i5.Meal>>>.value(
              _FakeResult_0<List<_i5.Meal>>(
                this,
                Invocation.method(#call, [], {#meals: meals, #sortBy: sortBy}),
...
/// A class which mocks [UpdateMealUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockUpdateMealUsecase extends _i1.Mock implements _i9.UpdateMealUsecase {
